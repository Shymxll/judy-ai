...
export const CaseNudgeProsecutorProcess: React.FC<Props> = ({ onNudge, loading }) => {
    ...
    return (
        <div className="flex flex-col items-center py-8">
                ...
                {showDurtGif ? (
                    <img
                        ...
                        onLoad={(e) => {
                            ...
                            setTimeout(() => {
                                handleDurtGifEnd()
                            }, 6000) // 2.5 saniye sonra sleep gif'ine dön
                        }}
                    />
                ) : (
                    <img
            ...
            {/* Buton */}
            <button
                className="mb-4 px-4 py-2 rounded bg-yellow-600 text-white font-heading hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed"
